...
class Router{
    ...
    private $afterRoutes        = array(); //@var array The route patterns and their handling functions
    private $beforeRoutes       = array(); //@var array The before middleware route patterns and their handling functions
    protected $notFoundCallback = [];      //@var array [object|callable] The function to be executed when no route has been matched
    private $baseRoute          = '';      //@var string Current base route, used for (sub)route mounting
    private $requestedMethod    = '';      //@var string The Request Method that needs to be handled
    private $serverBasePath;               //@var string The Server Base Path for Router Execution
    private $namespace          = '';      //@var string Default Controllers Namespace
